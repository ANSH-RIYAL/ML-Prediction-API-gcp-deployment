"""
Lifespan Prediction API - Clean version for GCP Cloud Run
"""
...
import os
import sys
import single_model_lib

# Make single_model_lib classes available in __main__ for pickle
for attr in dir(single_model_lib):
    if not attr.startswith('_'):
        setattr(sys.modules['__main__'], attr, getattr(single_model_lib, attr))
